...
async function processaTexto(caminhoDoArquivo){
    ...
    if(caminho[2] === 'leitura'){
       // let texto = await pegaArquivo(caminhoDoArquivo[2]);
        console.log(chalk.green.bgBlack("Leitura do arquivo: "), await lerArquivo(caminhoDoArquivo[1]));

    }

    else if(caminho[2] === 'links'){
        console.log(chalk.green.bgBlack("Leitura do arquivo: "), await pegaLink(caminhoDoArquivo[1]));
    }

    else if(caminho[2] === 'valida'){
